...
A: If you want to embed a Panopto video onto your page, your user normally needs to have iframe permissions. In a larger site where a user isn\'t an admin, they likely do not have the ability to embed an iframe.
...
Q: Can the html be formatted?
A: Not within the block itself. The iframe is generated within a div and a class `panopto-video`, so you may use css rules to format it. But if you have multiple panopto videos embedded on a single page, they would need other wrappers to differentiate the rules.
